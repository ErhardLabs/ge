...
$(document).ready(function() {
  ...
  $('#place_order').unbind().click(function(e) {
    ...
    if (($('#billing_first_name').val() == '') || ($('#billing_last_name').val() == '') || ($('#billing_email').val() == '')) {
      ...
      let result = confirm("I need your permission to email you new new music and show announcements. It's the only way I can give you free music! Please click OK to accept!");
      if (result) {
