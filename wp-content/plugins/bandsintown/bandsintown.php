...
// [bandsintown_events artist="Grayson Erhard Music" display_limit="10"]
...
class Bandsintown_JS_Plugin {
  ...
  function settings_inputs() {
   ...
   echo '<script type="text/javascript" src="https://www.bandsintown.com/javascripts/bit_widget.js"></script>
