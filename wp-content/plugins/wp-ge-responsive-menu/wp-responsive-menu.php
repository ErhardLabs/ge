<?php
/*
Plugin Name: Grayson's WP Responsive Menu
	...
	if($options['enabled']) :
		...
		<div id="wprmenu_bar" class="wprmenu_bar">
			...
			<div class="menu_title">
				...
				<?php if($options['bar_logo']) echo '<img id="bar_logo" class="bar_logo" src="'.$options['bar_logo'].'"/>' ?>
				<?php echo '<div id="mailing_list">'.do_shortcode('[gravityform id="1" title="false" description="false"]').'</div>'; ?>
			</div>
		</div>
		...
		<div id="wprmenu_menu" class="wprmenu_levels <?php echo $options['position'] ?> wprmenu_custom_icons">
			...
			<?php } ?>
			<div class="social_sticker_wrap">
				<?php echo do_shortcode('[social_stickers]'); ?>
			</div>
		</div>
