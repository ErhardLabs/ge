...
//             'post_excerpt'   => __('Search Results','WCISPlugin'), //[ <string> ] // For all your post excerpt needs.
    ...
    private function get_product_from_post($post_id)
    {
        ...
        $post_data = method_exists($product, 'get_post_data') ? $product->get_post_data() : get_post($product_id);
        if (
            !$product
    ...
    private function isp_is_visible($product) {
        ...
        return apply_filters( 'woocommerce_product_is_visible', $visible, $product_id );
    }
